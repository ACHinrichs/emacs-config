;;; deepest-blue-theme.el --- Custom theme for faces

;; Copyright (C) 2017 by Adrian C. Hinrichs <adrian.hinrichs@rwth-aachen.de>
;; Based uppon deeper-blue-theme by Scott Frazer <frazer.scott@gmail.com>, copyrighted by the Free Software Foundation Inc.


;; Eigene Farben: Tardis Blau: #003b6f

(deftheme deepest-blue
...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   ...
   `(linum ((,class (:foreground "LightBlue2" :background "#003b6f"))))
   ...
   `(mode-line ((,class (:background "cornflower blue" :foreground "black"))))
   `(mode-line-buffer-id ((,class (:weight bold :background nil :foreground "blue4"))))
   `(mode-line-inactive ((,class (:background "#003b6f" :foreground "black"))))
   ...
   `(region ((,class (:background "dodger blue"))))
...
(provide-theme 'deepest-blue)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; deepest-blue-theme.el ends here
