...
* LaTeX-Export
I think I need to load =ox-latex= before loading custom classes, otherwise they won't be recognized.
#+begin_src emacs-lisp  :tangle yes
  (require 'ox-latex)
#+end_src
...
#+begin_src emacs-lisp  :tangle yes
  (org-babel-load-file "~/.emacs.d/ox-latex/ajcclasses.org")
#+end_src

#+RESULTS:
: Loaded ~/.emacs.d/ox-latex/ajcclasses.el
...
#+RESULTS:
: Loaded ~/.emacs.d/ox-latex/ox-tufte.el

Load scrbook-chapter, whcih i use to be able to use the thesis template of i5 correctly

#+begin_src emacs-lisp  :tangle yes
  (org-babel-load-file "~/.emacs.d/ox-latex/ox-scrbook-chapter.org")
#+end_src

#+RESULTS:
: Loaded ~/.emacs.d/ox-latex/ox-scrbook-chapter.el

Load bkn classes
#+begin_src emacs-lisp  :tangle yes
  (org-babel-load-file (locate-user-emacs-file "ox-latex/bkclasses.org"))
#+end_src

#+RESULTS:
: Loaded ~/.emacs.d/ox-latex/bkclasses.el
